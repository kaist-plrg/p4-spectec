...
RUN opam init --disable-sandboxing --auto-setup && \
    ...
    eval $(opam env) && \
    opam install dune menhir bignum core core_unix bisect_ppx yojson ppx_deriving_yojson -y
...
# --------------------------------------
RUN document/install_asciidoctor-linux.sh
