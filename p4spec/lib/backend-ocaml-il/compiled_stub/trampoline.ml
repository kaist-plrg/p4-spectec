(* Stub Trampoline for the [spec_parts_il] library — copied into [compiled/]
   by `make restore-stub` so plain `make build` never compiles the heavy
   generated parts. Overwritten by `make gen-ocaml-il`.
