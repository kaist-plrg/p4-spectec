...
module Make (Interface : Run.INTERFACE) (Extern : Run.EXTERN) () :
  ...
  and invoke_table ?(internal : bool = true) (ctx : Ctx.t) (id : id)
    ...
    let invoke_body () = invoke_table_body ctx id tablerows values_input in
  ...
  and invoke_table_body (ctx : Ctx.t) (id : id) (tablerows : tablerow list)
      (values_input : value list) : value backtrack =
