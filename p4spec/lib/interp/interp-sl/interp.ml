...
module Make (Interface : Run.INTERFACE) (Extern : Run.EXTERN) () :
  ...
  and invoke_arrow ?(internal : bool = true) (ctx : Ctx.t) (id : id)
    ...
    | None -> (
        ...
        | Some _ -> invoke_table ctx id values_input
        | None -> back_err id.at (F.asprintf "function or table `%s` is undefined" id.it))

  and invoke_table (ctx : Ctx.t) (id : id) (values_input : value list) : value =
    try
      ...
      let value_output =
        ...
        then
          ...
          | None ->
              ...
              value_output
        else invoke_table_body ctx id params tablerows values_input
      in
