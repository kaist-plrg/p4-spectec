...
module Make (V : Valrep.SAFE) = struct
  ...
  let bits_of_value (value : V.t) : bool array =
    value |> V.Get.list |> List.map V.Get.bool |> Array.of_list

  let value_of_bits (add : V.t -> unit) (bits : bool array) : V.t =
    let value =
  ...
  let shl (add : V.t -> unit) (at : region) (targs : targ list)
  ...
  let shr (add : V.t -> unit) (at : region) (targs : targ list)
      (values_input : V.t list) : V.t =
    Extract.zero at targs;
    let value_base, value_offset = Extract.two at values_input in
    let base = bigint_of_value value_base in
  ...
  let shr_arith (add : V.t -> unit) (at : region) (targs : targ list)
      (values_input : V.t list) : V.t =
    Extract.zero at targs;
  ...
  let pow2 (add : V.t -> unit) (at : region) (targs : targ list)
      (values_input : V.t list) : V.t =
    Extract.zero at targs;
  ...
  let bitstr_to_int (add : V.t -> unit) (at : region) (targs : targ list)
      (values_input : V.t list) : V.t =
    Extract.zero at targs;
  ...
  let int_to_bitstr (add : V.t -> unit) (at : region) (targs : targ list)
      (values_input : V.t list) : V.t =
    Extract.zero at targs;
  ...
  let bits_to_int_unsigned (add : V.t -> unit) (at : region) (targs : targ list)
      (values_input : V.t list) : V.t =
    Extract.zero at targs;
  ...
  let bits_to_int_signed (add : V.t -> unit) (at : region) (targs : targ list)
      (values_input : V.t list) : V.t =
    Extract.zero at targs;
    let value_bits = Extract.one at values_input in
    let bits = bits_of_value value_bits in
  ...
  let int_to_bits_unsigned (add : V.t -> unit) (at : region) (targs : targ list)
      (values_input : V.t list) : V.t =
    Extract.zero at targs;
    let value_width, value_int = Extract.two at values_input in
    let width = bigint_of_value value_width in
  ...
  let int_to_bits_signed (add : V.t -> unit) (at : region) (targs : targ list)
      (values_input : V.t list) : V.t =
    Extract.zero at targs;
    let value_width, value_int = Extract.two at values_input in
    let width = bigint_of_value value_width in
  ...
  let bneg (add : V.t -> unit) (at : region) (targs : targ list)
      (values_input : V.t list) : V.t =
    Extract.zero at targs;
  ...
  let band (add : V.t -> unit) (at : region) (targs : targ list)
      (values_input : V.t list) : V.t =
    Extract.zero at targs;
  ...
  let bxor (add : V.t -> unit) (at : region) (targs : targ list)
      (values_input : V.t list) : V.t =
    Extract.zero at targs;
    let value_l, value_r = Extract.two at values_input in
    let rawint_l = bigint_of_value value_l in
  ...
  let bor (add : V.t -> unit) (at : region) (targs : targ list)
      (values_input : V.t list) : V.t =
    Extract.zero at targs;
    let value_l, value_r = Extract.two at values_input in
    let rawint_l = bigint_of_value value_l in
  ...
  let bitacc (add : V.t -> unit) (at : region) (targs : targ list)
      (values_input : V.t list) : V.t =
    Extract.zero at targs;
  ...
  let bitacc_replace' (b : Bigint.t) (m : Bigint.t) (l : Bigint.t)
      (r : Bigint.t) : Bigint.t =
  ...
  let bitacc_replace (add : V.t -> unit) (at : region) (targs : targ list)
      (values_input : V.t list) : V.t =
    Extract.zero at targs;
