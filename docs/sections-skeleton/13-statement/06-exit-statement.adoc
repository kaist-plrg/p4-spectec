...
// Section 12.5 of the P4-16 Language Specification
...
complete its execution. See <<sec-expr-eval-order>> for the order of evaluation
of the parts of an expression.  For the examples listed above, it also means
the following behavior after the expression evaluation is interrupted.
