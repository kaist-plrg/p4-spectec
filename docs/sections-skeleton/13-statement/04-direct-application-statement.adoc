...
// Section 15.1 of the P4-16 Language Specification ----
...
// Modified section 15.1 of the P4-16 Language Specification ----
...
At compile-time, a direct application statement is instantiated, and then
desugared into a method call on that instance.
