...
In P4~IR~, base types are subdivided into primitive types and integer types.
Base values are subdivided into primitive and integer values, accordingly.
...
[[primitiveTypeIR]]
[[primitiveValue]]
${syntax: primitiveTypeIR primitiveValue}
...
// Added
The surface primitive type `primitiveType` is type checked as described
below, producing `primitiveTypeIR`.

${rulegroup: Type_ok/primitiveType}
${ruleprose: Type_ok/primitiveType}
