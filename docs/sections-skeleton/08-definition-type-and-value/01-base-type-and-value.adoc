...
// Section 7.1 of the P4-16 Language Specification
...
In P4~IR~, base types are represented as:
...
The following sections describe each of these base types in more detail.
...
// Section 7.1.1 of the P4-16 Language Specification
...
// Section 7.1.4 of the P4-16 Language Specification
...
// Section 7.1.2 of the P4-16 Language Specification
...
// Added
The semantics of an error declaration is described in <<sec-errorDeclaration>>.
...
// Section 7.1.3 of the P4-16 Language Specification
...
// Added
The semantics of a match kind declaration is described in
<<sec-matchKindDeclaration>>.

[discrete]
===== Type checking match kind types
...
// Section 7.1.5 of the P4-16 Language Specification
The type `string` represents strings. The values of type `string` are either
string literals, or concatenations of multiple `string`-typed expression.
...
`string` can be only directionless (see Section <<#sec-calling-convention>>).
...
// Section 7.1.6 of the P4-16 Language Specification
...
// Section 7.1.6.1 of the P4-16 Language Specification
...
// Section 7.1.6.2 of the P4-16 Language Specification
...
<<sec-calling-convention>> for more details on directionless parameters.

[discrete]
====== Type checking arbitrary-precision integer types
...
// Section 7.1.6.3 of the P4-16 Language Specification
...
[discrete]
====== Type checking fixed-width signed integer types
...
`bit<(expression)>` where the width is a compile-time known value.
...
[discrete]
====== Type checking fixed-width unsigned integer types
...
`varbit<(expression)>` where the width is a compile-time known value.
...
[discrete]
====== Type checking dynamically-sized bit-string types

${rulegroup-source: Type_ok/variableBit}
${rulegroup-prose: Type_ok/variableBit}

[discrete]
==== Well-formedness of base types
