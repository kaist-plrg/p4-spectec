...
// Section 6.4 in the P4_16 Language Specification
...
// Section 6.4.1 in the P4_16 Language Specification
...
[#sec-lexical-literals]
==== Literal constants

[#sec-lexical-boolean-literals]
[#syn-booleanLiteral]
===== Boolean literals

${syntax: booleanLiteral}

// Section 6.4.3.1 in the P4_16 Language Specification
There are two Boolean literal constants: `true` and `false`.

[#sec-synatx-lexical-integer-literals]
[#syn-numberLiteral]
===== Integer literals

${syntax: numberLiteral}

// Section 6.4.3.2 in the P4_16 Language Specification
...
[#sec-lexical-string-literals]
[#syn-stringLiteral]
===== String literals

${syntax: stringLiteral}

// Section 6.4.3.3 in the P4_16 Language Specification
...
appears in the source code. There are no escape sequences that would be treated
...
[#sec-lexical-comments]
==== Comments

// Section 6.4.2 in the P4_16 Language Specification
...
[#sec-lexical-optional-trailing-commas]
[#syn-trailingCommaOpt]
==== Optional trailing commas

// Section 6.4.4 in the P4_16 Language Specification
