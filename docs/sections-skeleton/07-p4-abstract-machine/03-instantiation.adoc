...
parser TopParser(/*  */)(Checksum16 unit) { /* body omitted */}
control Pipe(/*  */) { /* body omitted */}
control TopDeparser(/*  */)(Checksum16 unit) { /* body omitted */}
...
the first example in <<sec-cp-names>>. One might be tempted to refer to `s.c1`
