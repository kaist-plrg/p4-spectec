...
// Modified section 18.1 in the P4-16 Language Specification
...
- The following expressions (`+`, `-`, `|+|`, `|-|`, `*`, `/`, `%`,
  `!`, `&`, `|`, `^`, `&&`, `||`, `<< `, `>>`, `~`, `>`, `<`, `==`, `!=`,
  `<=`, `>=`, `++`, `[:]`, `?:`) when their operands are all local compile-time known
  values.
...
values. A related spec issue is made here: https://github.com/p4lang/p4-spec/issues/1309.
...
- The following expressions (`+`, `-`, `|+|`, `|-|`, `*`, `/`, `%`,
  `!`, `&`, `|`, `^`, `&&`, `||`, `<< `, `>> `, `~`, `>`, `<`, `==`, `!=`,
  `<=`, `>=`, `++`, `[:]`, `?:`) when their operands are all compile-time known
  values.
- Expressions of the form `e.minSizeInBits()`, `e.minSizeInBytes()`,
